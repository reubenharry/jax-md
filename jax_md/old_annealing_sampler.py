...
class Sampler:
    ...
    def sample(self, steps_at_each_temp, tune_steps, num_chains, temp_schedule, x_initial= 'prior', random_key= None):
        ...
        def temp_level(state, iter):
            ...
            next_state, xs = self.sample_temp_level(steps_at_each_temp, tune_steps, x, u, l, g, key, L, eps, T)

            return next_state, xs
        ...
        return jax.lax.scan(temp_level, init= (x0, u0, l0, g0, key0, self.L, self.eps_initial), xs= jnp.arange(1, len(temp_schedule_ext)))[1]
